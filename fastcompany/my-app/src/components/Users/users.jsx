  ...
  return (
    <>
      <TableRow key={props._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
        ...
        <TableCell align="center"><Bookmark id={props._id} handleBookmark={props.handleBookmark} boolean={props.bookmark}/></TableCell>
        <TableCell align="center">
          <Button variant="contained" onClick={() => props.handleDelete(props._id, true)} color="error">
            Удалить
          </Button>
        </TableCell>
      </TableRow>
